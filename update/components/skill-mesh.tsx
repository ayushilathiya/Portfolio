...
/** Skills rendered as a connected mesh graph */
  ...
  return (
    <div className="relative panel p-4 min-h-[200px]">
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <line x1="50" y1="40" x2="200" y2="40" stroke="var(--accent-amber)" strokeWidth="0.5" />
        ...
        <line x1="200" y1="40" x2="200" y2="140" stroke="var(--accent-amber)" strokeWidth="0.5" opacity="0.6" />
        ...
        <line x1="275" y1="140" x2="275" y2="240" stroke="var(--accent-amber)" strokeWidth="0.5" opacity="0.5" />
      </svg>

      <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-4">
        {grouped.map(({ domain, items }, colIndex) => (
            ...
            <div className="flex flex-col items-center gap-1.5 w-full">
              {items.map((skill, i) => (
                <a
                  ...
                  style={{ animationDelay: `${colIndex * 40 + i * 20}ms` }}
                >
